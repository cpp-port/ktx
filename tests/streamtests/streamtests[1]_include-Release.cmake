if(EXISTS "C:/main/port/graphics3d/ktx/Release/streamtests.exe")
  if(NOT EXISTS "C:/main/port/graphics3d/ktx/tests/streamtests/streamtests[1]_tests-Release.cmake" OR
    ...
    gtest_discover_tests_impl(
      ...
      CTEST_FILE [==[C:/main/port/graphics3d/ktx/tests/streamtests/streamtests[1]_tests-Release.cmake]==]
      TEST_DISCOVERY_TIMEOUT [==[20]==]
      TEST_XML_OUTPUT_DIR [==[]==]
    )
  endif()
  include("C:/main/port/graphics3d/ktx/tests/streamtests/streamtests[1]_tests-Release.cmake")
else()
